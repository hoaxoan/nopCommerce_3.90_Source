...
namespace Nop.Plugin.Payments.CashOnDelivery
{
    ...
    public class CashOnDeliveryPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public CashOnDeliveryPaymentProcessor(ILocalizationService localizationService,
        ...
        {
            //settings
            _settingService.SaveSetting(new CashOnDeliveryPaymentSettings());
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payment.CashOnDelivery.PaymentMethodDescription", "Pay by purchase order (PO) number");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payment.CashOnDelivery.PurchaseOrderNumber", "PO Number");
        ...
        public override void Uninstall()
        {
            ...
            this.DeletePluginLocaleResource("Plugins.Payment.CashOnDelivery.PurchaseOrderNumber");
